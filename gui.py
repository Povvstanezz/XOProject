...
class Button():
    def __init__(self, size=(200,50), text='button', bg_color=(120, 120, 120), text_color=(0,0,0)):
        ...
        self.background_surface = pygame.Surface((200,50))
        ...
        #     pygame.draw.rect(self.background_surface, (180,180,180), (0,0,200,50))
        #     self.surfaces_update()
        # else:
        #     pygame.draw.rect(self.background_surface, (0,0,0), (0,0,200,50))
        #     self.surface_update()
    ...
    def on_mouse_motion(self, btn_start_pos, mouse_pos):
        ...
        if mouse_pos[0] > btn_start_pos[0] and mouse_pos[0] < btn_end_pos[0] and \
            ...
            pygame.draw.rect(self.background_surface, (100,100,100), (0,0,200,50))
            self.surfaces_update()
